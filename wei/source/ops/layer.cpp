...
BaseLayer::BaseLayer(
    ...
    : device_type_(device_type), layer_type_(layer_type), data_type_(data_type),
...
Layer::Layer(
    base::DeviceType device_type, LayerType layer_type, std::string layer_name
)
    : BaseLayer(
          device_type,
          layer_type,
...
base::Status
Layer::forward(const tensor::Tensor &input1, const tensor::Tensor &output1) {
