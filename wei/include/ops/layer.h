#ifndef WEI_INFER_OPS_LAYER_H_
#define WEI_INFER_OPS_LAYER_H_
...
class BaseLayer {
  public:
    ...
    virtual base::Status
    forward(const tensor::Tensor &input1, const tensor::Tensor &output1) = 0;
...
class Layer : public BaseLayer {
  public:
    ...
    base::Status forward(
        const tensor::Tensor &input1, const tensor::Tensor &output1
    ) override;
