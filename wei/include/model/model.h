#ifndef WEI_INFER_MODEL_MODEL_H_
#define WEI_INFER_MODEL_MODEL_H_
...
class Model {
  ...
  protected:
    virtual base::Status
    insert_buffer(ModelBufferType buffer_idx, const tensor::Tensor &tensor);
    ...
    virtual int32_t
    post_processing(const tensor::Tensor &pos, bool is_prompt) const = 0;
  ...
  private:
    ...
    slice_kv_cache(int32_t layer_idx, int32_t token_pos) const = 0;
...
#endif // WEI_INFER_MODEL_MODEL_H_
