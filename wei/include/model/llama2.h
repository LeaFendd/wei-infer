#ifndef WEI_INFER_MODEL_LLAMA2_H_
#define WEI_INFER_MODEL_LLAMA2_H_
...
class LLama2Model : public Model {
  ...
  private:
    ...
    void
    attention_mha(int32_t layer_idx, const tensor::Tensor &pos_tensor) const;
    ...
    void
    attention_qkv(int32_t layer_idx, const tensor::Tensor &pos_tensor) const;

    void cls_logits(const tensor::Tensor &input) const;

    int32_t
    post_processing(const tensor::Tensor &pos, bool is_prompt) const override;
...
#endif // WEI_INFER_MODEL_LLAMA2_H_
